...
public class Main {
    public static void main(String[] args) {
        ...
        int menu;       //메뉴를 입력받기 위한 변수 : menu

        boolean runLogin; //login 프로그램 실행을 위한 변수 : run
        int menuLogin;       //login 메뉴를 입력받기 위한 변수 : menu
        ...
        while (run) {
            ...
            switch (menu) {
                ...
                case 2:
                    ...
                    while (runLogin) {
                        System.out.println("─────────────────────────────────────────────────");
                        System.out.println(" [1]가위바위보\t[2]메모리\t[3]행맨\t\t[4]업다운");
                        System.out.println(" [5]블랙잭\t\t[6]돌림판\t[7]내정보\t[8]로그아웃");
                        System.out.println("─────────────────────────────────────────────────");
                        System.out.print("메뉴 선택 → ");
                        ...
                        //가위바위보에 들어가는 들이 존재하지 않으므로 1는 제외
                        if(menuLogin < 7 && menuLogin > 1) {        //게임 선택
                            if(!sql.gameMoney(id, menuLogin)) {     //게임에 들어가는 돈 차감
                                menuLogin = 0;                      //해당 유저의 돈이 부족함
                            }
                        }
